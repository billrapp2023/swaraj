...
import { BloodstatusService } from './bloodstatusver2.service';
...
@Component({
  selector: 'app-bloodstatusver2',
  templateUrl: './bloodstatusver2.component.html',
  styleUrls: ['./bloodstatusver2.component.css']
})
export class Bloodstatusver2Component implements OnInit {
